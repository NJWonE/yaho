...
public class ProjectCommandController {
    ...
    ProjectRegistService projectRegistService;

    @Autowired
    public ProjectCommandController(ProjectRegistService projectRegistService){
        this.projectRegistService = projectRegistService;
    }

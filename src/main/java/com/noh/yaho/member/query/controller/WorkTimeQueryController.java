...
public class WorkTimeQueryController {
    ...
    @GetMapping
    public ResponseDTO selectWorkTime(@RequestParam("memberNo")int memberNo) throws ParseException {
        return new ResponseDTO(HttpStatus.OK, "업무집중시간 조회 성공", workTimeQueryService.selectWorkTime(memberNo));
    }
}
